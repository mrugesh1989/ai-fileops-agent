...
# from strands.models.gemini import GeminiModel  # Dedicated Gemini class – this is the fix!
...
ollama_model = OpenAIModel(
    model_id="llama-3.3-70b-versatile",  # Free 70B model
    client_args={  # This configures the OpenAI client constructor (fixes base_url forwarding)
        "base_url": "https://api.groq.com/openai/v1",
        "timeout": 60.0,  # Optional: 60 seconds timeout
    },
    params={  # Only request params here—no base_url
        "temperature": 0.7,
        "max_tokens": 4096,
        "top_p": 0.9,
    },
...
# Gemini Model
# ollama_model = GeminiModel(
#     client_args={
#         "api_key": "AIzaSyCYQ5fYrt9COw-gXxJRQr-Q4MrA-92Rpoc",   # ← YOUR REAL GEMINI KEY HERE
#     },
#     model_id="gemini-2.5-flash",          # free, fast, and perfect for agents
#     params={
#         "temperature": 0.7,
#         "max_output_tokens": 4096,        # Gemini's version of max_tokens
#         "top_p": 0.9,
#     },
# )
